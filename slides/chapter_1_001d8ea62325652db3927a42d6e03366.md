...
- Cluster 1 - Medium Life Expectancy, Medium Fertility Rate, Low GDP
- Cluster 2 - High Life Expectancy, Low Fertility Rate, High GDP
...
```
![](https://live.staticflickr.com/65535/48193836596_90dfd12ff0_b.jpg)

`@script`
Finally, it is time to plot the cluster. Given the assumption that the chart should be used by non statisticians plotting the data and color coding it with the cluster seems like the most visually appealing way of showing the grouping 
